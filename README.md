...
Check the [releases](https://github.com/droboports/parted/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/parted.git
cd parted
./build.sh
ls -la *.tgz
```
